...
public class GenMatrixBlocksJob {
private static final Logger LOG = Logger.getLogger(GenMatrixBlocksJob.class.getName());
...
public static void main(String[] args) {
    ...
    jobBuilder.setWorkerClass(GenMatrixBlocks.class.getName());
